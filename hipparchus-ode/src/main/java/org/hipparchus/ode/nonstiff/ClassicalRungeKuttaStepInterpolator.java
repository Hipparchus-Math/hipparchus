...
class ClassicalRungeKuttaStepInterpolator
     ...
     */
    ClassicalRungeKuttaStepInterpolator(final boolean forward,
                                        final double[][] yDotK,
    ...
    /** {@inheritDoc} */
    @Override
    protected ClassicalRungeKuttaStepInterpolator create(final boolean newForward, final double[][] newYDotK,
        ...
        return new ClassicalRungeKuttaStepInterpolator(newForward, newYDotK,
