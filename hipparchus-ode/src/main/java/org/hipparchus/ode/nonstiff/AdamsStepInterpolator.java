...
class AdamsStepInterpolator extends AbstractODEStateInterpolator {
     ...
     */
    AdamsStepInterpolator(final double stepSize, final ODEStateAndDerivative reference,
     ...
     * @param equationsMapper mapper for ODE equations primary and secondary components
     */
    private AdamsStepInterpolator(final double stepSize, final ODEStateAndDerivative reference,
                                  final double[] scaled, final Array2DRowRealMatrix nordsieck,
                                  final boolean isForward,
                                  final ODEStateAndDerivative globalPreviousState,
                                  final ODEStateAndDerivative globalCurrentState,
     ...
     */
    protected AdamsStepInterpolator create(boolean newForward,
        ...
        return new AdamsStepInterpolator(scalingH, reference, scaled, nordsieck,
                                         newForward,
    ...
    public static ODEStateAndDerivative taylor(final ODEStateAndDerivative reference,
        ...
        double[] estimatedState = reference.getState();
