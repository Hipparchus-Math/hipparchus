...
class ThreeEighthesStepInterpolator
     ...
     */
    ThreeEighthesStepInterpolator(final boolean forward,
                                  final double[][] yDotK,
    ...
    /** {@inheritDoc} */
    @Override
    protected ThreeEighthesStepInterpolator create(final boolean newForward, final double[][] newYDotK,
        ...
        return new ThreeEighthesStepInterpolator(newForward, newYDotK,
