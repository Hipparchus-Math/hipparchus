...
class LutherFieldStateInterpolator<T extends RealFieldElement<T>>
    ...
    /** {@inheritDoc} */
    @Override
    protected LutherFieldStateInterpolator<T> create(final Field<T> newField, final boolean newForward, final T[][] newYDotK,
