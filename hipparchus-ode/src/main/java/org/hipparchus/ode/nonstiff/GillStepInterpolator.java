...
class GillStepInterpolator
     ...
     */
    GillStepInterpolator(final boolean forward,
                         final double[][] yDotK,
    ...
    /** {@inheritDoc} */
    @Override
    protected GillStepInterpolator create(final boolean newForward, final double[][] newYDotK,
        ...
        return new GillStepInterpolator(newForward, newYDotK,
