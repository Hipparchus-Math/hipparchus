...
public abstract class AdamsFieldIntegrator<T extends CalculusFieldElement<T>> extends MultistepFieldIntegrator<T> {
     ...
     * <pre>
     * <var>r<sub>n+1</sub> = (s<sub>1</sub>(n) - s<sub>1</sub>(n+1)) P<sup>-1</sup> u + P<sup>-1</sup> A P r<sub>n</sub></var>
     * </pre>
     * <var>this method computes the P<sup>-1</sup> A P r<sub>n</sub> part.</var>
