...
public class DormandPrince54IntegratorTest {
    ...
    public void testMinStep()
        ...
        ODEIntegrator integ = new DormandPrince54Integrator(minStep, maxStep,
    ...
    private static class DP54SmallLastHandler implements ODEStepHandler {
        ...
        public void handleStep(ODEStateInterpolator interpolator, boolean isLast) {
            if (isLast) {
                lastSeen = true;
                double h = interpolator.getCurrentState().getTime() -
