...
public class MidpointFieldStateInterpolatorTest extends RungeKuttaFieldStateInterpolatorAbstractTest {
    ...
    public void interpolationInside() {
        doInterpolationInside(Binary64Field.getInstance(), 3.3e-4, 1.1e-5);
    }

    @Test
    public void nonFieldInterpolatorConsistency() {
        doNonFieldInterpolatorConsistency(Binary64Field.getInstance(), 1.4e-17, 1.0e-50, 1.0e-50, 7.0e-18);
    }
