...
public class MidpointStateInterpolatorTest extends RungeKuttaStateInterpolatorAbstractTest {
    ...
    protected ButcherArrayProvider createButcherArrayProvider() {
        return new MidpointIntegrator(1.0);
    }
    ...
    public void interpolationInside() {
        doInterpolationInside(3.3e-4, 1.1e-5);
    }
