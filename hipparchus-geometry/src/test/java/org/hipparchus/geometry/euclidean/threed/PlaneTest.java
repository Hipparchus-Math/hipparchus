...
public class PlaneTest {
    ...
    public void testContains() throws MathRuntimeException {
        ...
        Assertions.assertTrue(p.contains(new Vector3D(0, 0, 1)));
        Assertions.assertTrue(p.contains(new Vector3D(17, -32, 1)));
        Assertions.assertFalse(p.contains(new Vector3D(17, -32, 1.001)));
    }
    ...
    public void testOffset() throws MathRuntimeException {
        ...
        Assertions.assertEquals(-5.0, p.getOffset(new Vector3D(-4, 0, 0)), 1.0e-10);
        Assertions.assertEquals(+5.0, p.getOffset(new Vector3D(6, 10, -12)), 1.0e-10);
    ...
    public void testPoint() throws MathRuntimeException {
        ...
        Assertions.assertTrue(p.contains(p.getOrigin()));
    }
    ...
    public void testThreePoints() throws MathRuntimeException {
        ...
        Assertions.assertTrue(p.contains(p1));
        Assertions.assertTrue(p.contains(p2));
        Assertions.assertTrue(p.contains(p3));
    }
    ...
    public void testIntersection() throws MathRuntimeException, MathIllegalArgumentException {
        ...
        Assertions.assertTrue(p.contains(point));
        Assertions.assertTrue(l.contains(point));
        Assertions.assertNull(p.intersection(new Line(new Vector3D(10, 10, 10),
    ...
    public void testIntersection2() throws MathRuntimeException {
        ...
        Assertions.assertTrue(l.contains(p2));
        Assertions.assertNull(pA.intersection(pA));
    }
    ...
    public void testIntersection3() throws MathRuntimeException {
        ...
        Assertions.assertEquals(reference.getX(), p.getX(), 1.0e-10);
        Assertions.assertEquals(reference.getY(), p.getY(), 1.0e-10);
        Assertions.assertEquals(reference.getZ(), p.getZ(), 1.0e-10);
    }
    ...
    public void testSimilar() throws MathRuntimeException {
        ...
        Plane    pB  = new Plane(p1, new Vector3D (11.4, -3.8, 5.1), p2, 1.0e-10);
        Assertions.assertFalse(pA.isSimilarTo(pB));
        Assertions.assertTrue(pA.isSimilarTo(pA));
        Assertions.assertTrue(pA.isSimilarTo(new Plane(p1, p3, p2, 1.0e-10)));
        Vector3D shift = new Vector3D(0.3, pA.getNormal());
        Assertions.assertFalse(pA.isSimilarTo(new Plane(p1.add(shift),
            p3.add(shift),
            p2.add(shift),
            1.0e-10)));
    }
