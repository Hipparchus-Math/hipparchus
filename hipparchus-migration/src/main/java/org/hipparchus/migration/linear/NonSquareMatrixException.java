...
public class NonSquareMatrixException
    extends org.hipparchus.migration.exception.DimensionMismatchException {
    ...
    public NonSquareMatrixException(int wrong,
                                    int expected) {
        super(org.hipparchus.migration.exception.util.LocalizedFormats.NON_SQUARE_MATRIX, wrong, expected);
    }
}
