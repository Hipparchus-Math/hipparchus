...
public class FieldComplexTest extends CalculusFieldElementAbstractTest<FieldComplex<Binary64>> {
    ...
    public void testConstructor() {
        ...
        Assertions.assertEquals(3.0, z.getRealPart().getReal(), 1.0e-5);
        Assertions.assertEquals(4.0, z.getImaginary().getReal(), 1.0e-5);
        Assertions.assertEquals(3.0, z.getRealPart().getReal(), 1.0e-5);
        Assertions.assertEquals(4.0, z.getImaginaryPart().getReal(), 1.0e-5);
    }
    ...
    public void testNorm() {
        FieldComplex<Binary64> z = build(3.0, 4.0);
        Assertions.assertEquals(5.0, z.norm(), 1.0e-5);
    }

    @Test
    public void testNormNaN() {
        Assertions.assertTrue(Double.isNaN(FieldComplex.getNaN(Binary64Field.getInstance()).norm()));
        FieldComplex<Binary64> z = build(Double.POSITIVE_INFINITY, Double.NaN);
        Assertions.assertTrue(Double.isNaN(z.norm()));
    }
    ...
    public void testNormInfinite() {
        ...
        Assertions.assertEquals(Double.POSITIVE_INFINITY, z.norm(), 0);
    ...
    public void testAdd() {
        ...
        Assertions.assertEquals(8.0, z.getRealPart().getReal(), 1.0e-5);
        Assertions.assertEquals(10.0, z.getImaginary().getReal(), 1.0e-5);
    }
    ...
    public void testAddInf() {
        ...
        FieldComplex<Binary64> w = x.add(z);
        Assertions.assertEquals(1, w.getImaginary().getReal(), 0);
        Assertions.assertEquals(Double.POSITIVE_INFINITY, w.getRealPart().getReal(), 0);
    ...
    public void testScalarAdd() {
        ...
        Assertions.assertEquals(x.add(yComplex), x.add(new Binary64(yDouble)));
    }
    ...
    public void testScalarAddNaN() {
        ...
        Assertions.assertEquals(x.add(yComplex), x.add(yDouble));
        Assertions.assertEquals(x.add(yComplex), x.add(new Binary64(yDouble)));
        Assertions.assertTrue(build(Double.NaN).add(0).isNaN());
        Assertions.assertTrue(build(Double.NaN).add(Binary64.ZERO).isNaN());
    }
    ...
    public void testConjugateInfiinite() {
        ...
        Assertions.assertEquals(Double.NEGATIVE_INFINITY, z.conjugate().getImaginary().getReal(), 0);
        z = build(0, Double.NEGATIVE_INFINITY);
        Assertions.assertEquals(Double.POSITIVE_INFINITY, z.conjugate().getImaginary().getReal(), 0);
    }
    ...
    public void testDivide() {
        ...
        Assertions.assertEquals(39.0 / 61.0, z.getRealPart().getReal(), 1.0e-5);
        Assertions.assertEquals(2.0 / 61.0, z.getImaginaryPart().getReal(), 1.0e-5);
    }
    ...
    public void testDivideReal() {
        ...
        Assertions.assertEquals(build(1d, 1.5), x.divide(y));
    ...
    public void testDivideImaginary() {
        ...
        Assertions.assertEquals(build(1.5d, -1d), x.divide(y));
    }
    ...
    public void testDivideInf() {
        ...
        Assertions.assertEquals(x.divide(w), FieldComplex.getZero(Binary64Field.getInstance()));

        FieldComplex<Binary64> z = w.divide(x);
        Assertions.assertTrue(Double.isNaN(z.getReal()));
        Assertions.assertEquals(Double.POSITIVE_INFINITY, z.getImaginary().getReal(), 0);

        w = build(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY);
        z = w.divide(x);
        Assertions.assertTrue(Double.isNaN(z.getImaginary().getReal()));
        Assertions.assertEquals(Double.POSITIVE_INFINITY, z.getRealPart().getReal(), 0);
    ...
    public void testDivideZero() {
        ...
        Assertions.assertEquals(z, FieldComplex.getNaN(Binary64Field.getInstance()));
        Assertions.assertTrue(build(3.0).divide(Binary64.ZERO).isNaN());
    }
    ...
    public void testDivideNaN() {
        ...
        Assertions.assertTrue(z.isNaN());
        Assertions.assertTrue(x.divide(Binary64.NAN).isNaN());
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).divide(Binary64.ONE).isNaN());
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).divide(FieldComplex.getNaN(Binary64Field.getInstance())).isNaN());
    }
    ...
    public void testScalarDivide() {
        ...
        Assertions.assertEquals(x.divide(yComplex), x.divide(new Binary64(yDouble)));
    }
    ...
    public void testScalarDivideNaN() {
        ...
        Assertions.assertEquals(x.divide(yComplex), x.divide(yDouble));
        Assertions.assertEquals(x.divide(yComplex), x.divide(new Binary64(yDouble)));
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).divide(Double.NaN).isNaN());
    }
    ...
    public void testReciprocal() {
        ...
        Assertions.assertEquals(expRe, act.getRealPart().getReal(), FastMath.ulp(expRe));
        Assertions.assertEquals(expIm, act.getImaginaryPart().getReal(), FastMath.ulp(expIm));
    }

    @Test
    public void testReciprocalReal() {
        FieldComplex<Binary64> z = build(-2.0, 0.0);
        Assertions.assertTrue(FieldComplex.equals(build(-0.5, 0.0), z.reciprocal()));
    }

    @Test
    public void testReciprocalImaginary() {
        FieldComplex<Binary64> z = build(0.0, -2.0);
        Assertions.assertEquals(build(0.0, 0.5), z.reciprocal());
    }

    @Test
    public void testReciprocalInf() {
        FieldComplex<Binary64> z = build(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
        Assertions.assertEquals(z.reciprocal(), FieldComplex.getZero(Binary64Field.getInstance()));

        z = build(1, Double.POSITIVE_INFINITY).reciprocal();
        Assertions.assertEquals(z, FieldComplex.getZero(Binary64Field.getInstance()));
    }

    @Test
    public void testReciprocalZero() {
        Assertions.assertEquals(FieldComplex.getZero(Binary64Field.getInstance()).reciprocal(), FieldComplex.getInf(Binary64Field.getInstance()));
    }

    @Test
    public void testReciprocalNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).reciprocal().isNaN());
    }
    ...
    public void testMultiply() {
        ...
        Assertions.assertEquals(-9.0, z.getRealPart().getReal(), 1.0e-5);
        Assertions.assertEquals(38.0, z.getImaginaryPart().getReal(), 1.0e-5);
    }

    @Test
    public void testMultiplyT() {
        FieldComplex<Binary64> z = build(3.0, 4.0).multiply(new Binary64(5.0));
        Assertions.assertEquals(15.0, z.getRealPart().getReal(), 1.0e-5);
        Assertions.assertEquals(20.0, z.getImaginaryPart().getReal(), 1.0e-5);
    }
    ...
    public void testMultiplyNaNInf() {
        ...
        Assertions.assertEquals(Double.POSITIVE_INFINITY, w.getRealPart().getReal(), 0);
        Assertions.assertEquals(Double.POSITIVE_INFINITY, w.getImaginaryPart().getReal(), 0);

        // [MATH-164]
        Assertions.assertEquals(build(1, 0).multiply(infInf), FieldComplex.getInf(Binary64Field.getInstance()));
        Assertions.assertEquals(build(-1, 0).multiply(infInf), FieldComplex.getInf(Binary64Field.getInstance()));
        Assertions.assertEquals(build(1, 0).multiply(negInfZero), FieldComplex.getInf(Binary64Field.getInstance()));
        ...
        Assertions.assertTrue(w.getRealPart().isNaN());
        Assertions.assertTrue(w.getImaginaryPart().isNaN());
    ...
    public void testScalarMultiply() {
        ...
        Assertions.assertEquals(x.multiply(yComplex), x.multiply(new Binary64(yDouble)));
        int zInt = -5;
    ...
    public void testScalarMultiplyNaN() {
        ...
        Assertions.assertEquals(x.multiply(yComplex), x.multiply(yDouble));
        Assertions.assertEquals(x.multiply(yComplex), x.multiply(new Binary64(yDouble)));
        Assertions.assertTrue(build(Double.NaN, 0).multiply(5).isNaN());
        Assertions.assertTrue(build(Double.NaN, 0).multiply(new Binary64(5)).isNaN());
        Assertions.assertTrue(build(0, Double.NaN).multiply(5).isNaN());
        Assertions.assertTrue(build(0, Double.NaN).multiply(new Binary64(5)).isNaN());
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).multiply(5).isNaN());
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).multiply(new Binary64(5)).isNaN());
        Assertions.assertTrue(build(Double.NaN, 0).multiply(5.0).isNaN());
        Assertions.assertTrue(build(Double.NaN, 0).multiply(new Binary64(5)).isNaN());
        Assertions.assertTrue(build(0, Double.NaN).multiply(5.0).isNaN());
        Assertions.assertTrue(build(0, Double.NaN).multiply(new Binary64(5)).isNaN());
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).multiply(5.0).isNaN());
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).multiply(new Binary64(5.0)).isNaN());
        Assertions.assertTrue(FieldComplex.getOne(Binary64Field.getInstance()).multiply(Double.NaN).isNaN());
        Assertions.assertTrue(FieldComplex.getOne(Binary64Field.getInstance()).multiply(new Binary64(Double.NaN)).isNaN());
    }
    ...
    public void testScalarMultiplyInf() {
        ...
        Assertions.assertTrue(build(Double.POSITIVE_INFINITY, 0).multiply(5).isInfinite());
        Assertions.assertTrue(build(Double.POSITIVE_INFINITY, 0).multiply(new Binary64(5)).isInfinite());
        Assertions.assertTrue(build(0, Double.POSITIVE_INFINITY).multiply(5).isInfinite());
        Assertions.assertTrue(build(0, Double.POSITIVE_INFINITY).multiply(new Binary64(5)).isInfinite());
        Assertions.assertTrue(FieldComplex.getInf(Binary64Field.getInstance()).multiply(5).isInfinite());
        Assertions.assertTrue(FieldComplex.getInf(Binary64Field.getInstance()).multiply(new Binary64(5)).isInfinite());
        Assertions.assertTrue(build(Double.POSITIVE_INFINITY, 0).multiply(5.0).isInfinite());
        Assertions.assertTrue(build(Double.POSITIVE_INFINITY, 0).multiply(new Binary64(5.0)).isInfinite());
        Assertions.assertTrue(build(0, Double.POSITIVE_INFINITY).multiply(5.0).isInfinite());
        Assertions.assertTrue(build(0, Double.POSITIVE_INFINITY).multiply(new Binary64(5.0)).isInfinite());
        Assertions.assertTrue(FieldComplex.getInf(Binary64Field.getInstance()).multiply(5.0).isInfinite());
        Assertions.assertTrue(FieldComplex.getInf(Binary64Field.getInstance()).multiply(new Binary64(5.0)).isInfinite());
        Assertions.assertTrue(FieldComplex.getOne(Binary64Field.getInstance()).multiply(Double.POSITIVE_INFINITY).isInfinite());
        Assertions.assertTrue(FieldComplex.getOne(Binary64Field.getInstance()).multiply(new Binary64(Double.POSITIVE_INFINITY)).isInfinite());
    }
    ...
    public void testSubtract() {
        ...
        Assertions.assertEquals(-2.0, z.getRealPart().getReal(), 1.0e-5);
        Assertions.assertEquals(-2.0, z.getImaginaryPart().getReal(), 1.0e-5);
    }
    ...
    public void testSubtractInf() {
        ...
        FieldComplex<Binary64> w = x.subtract(z);
        Assertions.assertEquals(1, w.getImaginaryPart().getReal(), 0);
        Assertions.assertEquals(Double.POSITIVE_INFINITY, w.getRealPart().getReal(), 0);
    ...
    public void testScalarSubtract() {
        ...
        Assertions.assertEquals(x.subtract(yComplex), x.subtract(new Binary64(yDouble)));
    }
    ...
    public void testScalarSubtractNaN() {
        ...
        Assertions.assertEquals(x.subtract(yComplex), x.subtract(yDouble));
        Assertions.assertEquals(x.subtract(yComplex), x.subtract(new Binary64(yDouble)));
        Assertions.assertTrue(build(Double.NaN).subtract(0).isNaN());
        Assertions.assertTrue(build(Double.NaN).subtract(Binary64.ZERO).isNaN());
    }
    ...
    public void testFloatingPointEquals() {
        ...
        Assertions.assertTrue(FieldComplex.equals(x, y));
        ...
        y = build(re, im);
        Assertions.assertTrue(FieldComplex.equals(x, y, maxUlps));

        re = FastMath.nextUp(re);
        im = FastMath.nextUp(im);
        y = build(re, im);
        Assertions.assertFalse(FieldComplex.equals(x, y, maxUlps));
    }

    @Test
    public void testFloatingPointEqualsNaN() {
        FieldComplex<Binary64> c = build(Double.NaN, 1);
        Assertions.assertFalse(FieldComplex.equals(c, c));
    ...
    public void testFloatingPointEqualsWithAllowedDelta() {
        ...
        Assertions.assertTrue(FieldComplex.equals(x, y, tol1));

        final double tol2 = 0.0624;
        Assertions.assertFalse(FieldComplex.equals(x, y, tol2));
    }
    ...
    public void testFloatingPointEqualsWithAllowedDeltaNaN() {
        ...
        Assertions.assertFalse(FieldComplex.equals(x, FieldComplex.getZero(Binary64Field.getInstance()), 0.1));
        Assertions.assertFalse(FieldComplex.equals(x, x, 0.1));
        Assertions.assertFalse(FieldComplex.equals(x, y, 0.1));
    }
    ...
    public void testFloatingPointEqualsWithRelativeTolerance() {
        ...
        Assertions.assertTrue(FieldComplex.equalsWithRelativeTolerance(x, y, tol));
    }
    ...
    public void testFloatingPointEqualsWithRelativeToleranceNaN() {
        final FieldComplex<Binary64> x = build(0, Double.NaN);
        final FieldComplex<Binary64> y = build(Double.NaN, 0);
        Assertions.assertFalse(FieldComplex.equalsWithRelativeTolerance(x, FieldComplex.getZero(Binary64Field.getInstance()), 0.1));
        Assertions.assertFalse(FieldComplex.equalsWithRelativeTolerance(x, x, 0.1));
        Assertions.assertFalse(FieldComplex.equalsWithRelativeTolerance(x, y, 0.1));
    }
    ...
    public void testEqualsNaN() {
        ...
        Assertions.assertEquals(realNaN, imaginaryNaN);
        Assertions.assertEquals(imaginaryNaN, complexNaN);
        Assertions.assertEquals(realNaN, complexNaN);
    }
    ...
    public void testHashCode() {
        ...
        Assertions.assertEquals(imaginaryNaN.hashCode(), FieldComplex.getNaN(Binary64Field.getInstance()).hashCode());
    ...
    public void testAcosNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).acos().isNaN());
    }
    ...
    public void testAsinNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).asin().isNaN());
    }
    ...
    public void testAtanI() {
        Assertions.assertTrue(FieldComplex.getI(Binary64Field.getInstance()).atan().isNaN());
    }

    @Test
    public void testAtanNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).atan().isNaN());
    }
    ...
    public void testAtanBranchCuts() {
        ...
        UnitTestUtils.assertEquals(build(0.0, +0.25541281188299534160),
                                   ...
                                   1.0e-14);
        Assertions.assertTrue(FastMath.copySign(1.0, FastMath.atan(build(+0.0, 0.25)).getReal()) > 0.0);
        UnitTestUtils.assertEquals(build(0.0, +0.25541281188299534160),
                                   FastMath.atan(build(-0.0, 0.25)),
                                   1.0e-14);
        Assertions.assertTrue(FastMath.copySign(1.0, FastMath.atan(build(-0.0, 0.25)).getReal()) < 0.0);
            ...
            for (double i1 : Arrays.asList(-2, 0, 2)) {
                ...
                for (double r2 : Arrays.asList(-1, 1)) {
                    for (double i2 : Arrays.asList(-5, 0, 5)) {
                        ...
                        Assertions.assertTrue(FastMath.abs(deltaR - FastMath.rint(deltaR)) < 1.0e-14);
                        Assertions.assertEquals(atan.getImaginaryPart().getReal(), atan2.getImaginaryPart().getReal(), 1.0e-14);
                    }
                }
            }
        }
    ...
    public void testAtan2Real() {
        for (double r1 : Arrays.asList(-3, 3)) {
            ...
            for (double r2 : Arrays.asList(-1, 1)) {
                ...
                Assertions.assertEquals(FastMath.atan2(r1, r2),
    ...
    public void testCosNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).cos().isNaN());
    }
    ...
    public void testCoshNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).cosh().isNaN());
    }
    ...
    public void testExpNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).exp().isNaN());
    }
    ...
    public void testExpM1() {
        ...
        Assertions.assertEquals(FastMath.expm1(testValue), build(testValue, 0).expm1().getRealPart().getReal(), 1.0e-30);
        Assertions.assertTrue(FastMath.expm1(testValue) - build(testValue).exp().subtract(1.0).getReal() > 4.0e-19);
        Assertions.assertEquals(0.0, build(0, testValue).expm1().getRealPart().getReal(), 1.0e-30);
        Assertions.assertEquals(0.0, build(0, testValue).expm1().getImaginaryPart().getReal(), 1.0e-30);
    }
    ...
    public void testLogNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).log().isNaN());
    }
    ...
    public void testLog10() {
        for (double x = -0.9; x < 0.9; x += 0.05) {
            if (x < 0) {
                ...
                Assertions.assertFalse(build(x).log10().isNaN());
            } else {
        ...
        for (double x = -0.9; x < 0.9; x += 0.05) {
            for (double y = 0.1; y < 4; y += 0.2) {
                if ( x < 0) {
                    // special case for Complex
                    Assertions.assertTrue(Double.isNaN(FastMath.pow(x, y)));
                    Assertions.assertFalse(build(x).pow(new Binary64(y)).isNaN());
                } else {
    ...
    public void testPowNaNBase() {
        FieldComplex<Binary64> x = build(3, 4);
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).pow(x).isNaN());
    }

    @Test
    public void testPowNaNExponent() {
        FieldComplex<Binary64> x = build(3, 4);
        Assertions.assertTrue(x.pow(FieldComplex.getNaN(Binary64Field.getInstance())).isNaN());
    }
    ...
    public void testScalarPow() {
        ...
        Assertions.assertEquals(x.pow(yComplex), x.pow(new Binary64(yDouble)));
        UnitTestUtils.assertEquals(FieldComplex.getOne(Binary64Field.getInstance()).negate(),
   ...
   public void testScalarPowZero() {
    ...
    public void testSinNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).sin().isNaN());
    }
    ...
    public void testSinhNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).sinh().isNaN());
    }
        ...
        for (double x = -2; x <= 2; x += 0.125) {
            for (double y = -2; y <= 2; y += 0.125) {
                ...
                if (FastMath.abs(x) == 1.0 && y == 0.0) {
                    Assertions.assertTrue(z.atanh().isInfinite());
                } else {
    ...
    public void testSqrtNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).sqrt().isNaN());
    }
    ...
    public void testSqrt1zNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).sqrt1z().isNaN());
    }
    ...
    public void testCbrt() {
        for (double x = -0.9; x < 0.9; x += 0.05) {
            if ( x < 0) {
                ...
                Assertions.assertEquals(FastMath.PI / 3, build(x).cbrt().getArgument().getReal(), 1.0e-15);
            } else {
    ...
    public void testCbrtComplex() {
        ...
        Assertions.assertEquals(1.0, cbrtPlus.getRealPart().getReal(), 1.0e-15);
        Assertions.assertEquals(FastMath.sqrt(3.0), cbrtPlus.getImaginaryPart().getReal(), 1.0e-15);
        ...
        Assertions.assertEquals(1.0, cbrtMinus.getRealPart().getReal(), 1.0e-15);
        Assertions.assertEquals(-FastMath.sqrt(3.0), cbrtMinus.getImaginaryPart().getReal(), 1.0e-15);
    }
        ...
        for (double x = -0.9; x < 0.9; x += 0.05) {
            for (int n = 1; n < 5; ++n) {
                if (x < 0) {
                    ...
                    Assertions.assertEquals(FastMath.PI / n, build(x).rootN(n).getArgument().getReal(), 1.0e-15);
                } else {
    ...
    public void testTanNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).tan().isNaN());
    }
   ...
   public void testTanCritical() {
    ...
    public void testTanhNaN() {
        Assertions.assertTrue(FieldComplex.getNaN(Binary64Field.getInstance()).tanh().isNaN());
    }
    ...
    public void testMath221() {
        Assertions.assertTrue(FieldComplex.equals(build(0,-1), build(0,1).multiply(build(-1,0))));
    }
    ...
    public void testNthRoot_normal_thirdRoot() {
        ...
        Assertions.assertEquals(3, thirdRootsOfZ.size());
        // test z_0
        Assertions.assertEquals(1.0,                  thirdRootsOfZ.get(0).getRealPart().getReal(),      1.0e-5);
        Assertions.assertEquals(1.0,                  thirdRootsOfZ.get(0).getImaginaryPart().getReal(), 1.0e-5);
        // test z_1
        Assertions.assertEquals(-1.3660254037844386,  thirdRootsOfZ.get(1).getRealPart().getReal(),      1.0e-5);
        Assertions.assertEquals(0.36602540378443843,  thirdRootsOfZ.get(1).getImaginaryPart().getReal(), 1.0e-5);
        // test z_2
        Assertions.assertEquals(0.366025403784439,    thirdRootsOfZ.get(2).getRealPart().getReal(),      1.0e-5);
        Assertions.assertEquals(-1.3660254037844384,  thirdRootsOfZ.get(2).getImaginaryPart().getReal(), 1.0e-5);
    }
    ...
    public void testNthRoot_normal_fourthRoot() {
        ...
        // Returned Collection must not be empty!
        Assertions.assertEquals(4, fourthRootsOfZ.size());
        // test z_0
        Assertions.assertEquals(1.5164629308487783,     fourthRootsOfZ.get(0).getRealPart().getReal(),      1.0e-5);
        Assertions.assertEquals(-0.14469266210702247,   fourthRootsOfZ.get(0).getImaginaryPart().getReal(), 1.0e-5);
        // test z_1
        Assertions.assertEquals(0.14469266210702256,    fourthRootsOfZ.get(1).getRealPart().getReal(),      1.0e-5);
        Assertions.assertEquals(1.5164629308487783,     fourthRootsOfZ.get(1).getImaginaryPart().getReal(), 1.0e-5);
        // test z_2
        Assertions.assertEquals(-1.5164629308487783,    fourthRootsOfZ.get(2).getRealPart().getReal(),      1.0e-5);
        Assertions.assertEquals(0.14469266210702267,    fourthRootsOfZ.get(2).getImaginaryPart().getReal(), 1.0e-5);
        // test z_3
        Assertions.assertEquals(-0.14469266210702275,   fourthRootsOfZ.get(3).getRealPart().getReal(),      1.0e-5);
        Assertions.assertEquals(-1.5164629308487783,    fourthRootsOfZ.get(3).getImaginaryPart().getReal(), 1.0e-5);
    }
    ...
    public void testNthRoot_cornercase_thirdRoot_imaginaryPartEmpty() {
        ...
        Assertions.assertEquals(3, thirdRootsOfZ.size());
        // test z_0
        Assertions.assertEquals(2.0,                thirdRootsOfZ.get(0).getRealPart().getReal(),      1.0e-5);
        Assertions.assertEquals(0.0,                thirdRootsOfZ.get(0).getImaginaryPart().getReal(), 1.0e-5);
        // test z_1
        Assertions.assertEquals(-1.0,               thirdRootsOfZ.get(1).getRealPart().getReal(),      1.0e-5);
        Assertions.assertEquals(1.7320508075688774, thirdRootsOfZ.get(1).getImaginaryPart().getReal(), 1.0e-5);
        // test z_2
        Assertions.assertEquals(-1.0,               thirdRootsOfZ.get(2).getRealPart().getReal(),      1.0e-5);
        Assertions.assertEquals(-1.732050807568877, thirdRootsOfZ.get(2).getImaginaryPart().getReal(), 1.0e-5);
    }
    ...
    public void testNthRoot_cornercase_thirdRoot_realPartZero() {
        ...
        Assertions.assertEquals(3, thirdRootsOfZ.size());
        // test z_0
        Assertions.assertEquals(1.0911236359717216,      thirdRootsOfZ.get(0).getRealPart().getReal(),      1.0e-5);
        Assertions.assertEquals(0.6299605249474365,      thirdRootsOfZ.get(0).getImaginaryPart().getReal(), 1.0e-5);
        // test z_1
        Assertions.assertEquals(-1.0911236359717216,     thirdRootsOfZ.get(1).getRealPart().getReal(),      1.0e-5);
        Assertions.assertEquals(0.6299605249474365,      thirdRootsOfZ.get(1).getImaginaryPart().getReal(), 1.0e-5);
        // test z_2
        Assertions.assertEquals(-2.3144374213981936E-16, thirdRootsOfZ.get(2).getRealPart().getReal(),      1.0e-5);
        Assertions.assertEquals(-1.2599210498948732,     thirdRootsOfZ.get(2).getImaginaryPart().getReal(), 1.0e-5);
    }
    ...
    public void testNthRoot_cornercase_NAN_Inf() {
        ...
        Assertions.assertEquals(FieldComplex.getNaN(Binary64Field.getInstance()), roots.get(0));
        ...
        Assertions.assertEquals(1,roots.size());
        Assertions.assertEquals(FieldComplex.getInf(Binary64Field.getInstance()), roots.get(0));
    ...
    public void testNthRootError() {
        try {
            ...
            Assertions.assertEquals(LocalizedCoreFormats.CANNOT_COMPUTE_NTH_ROOT_FOR_NEGATIVE_N,
                                miae.getSpecifier());
        }
    }
    ...
    private void doTestIsMathmeaticalInteger(double imaginary, boolean expectedForInteger) {
        Assertions.assertFalse(build(Double.NaN, imaginary).isMathematicalInteger());
        Assertions.assertFalse(build(Double.POSITIVE_INFINITY, imaginary).isMathematicalInteger());
        Assertions.assertFalse(build(Double.NEGATIVE_INFINITY, imaginary).isMathematicalInteger());
        Assertions.assertFalse(build(Double.MIN_NORMAL, imaginary).isMathematicalInteger());
        Assertions.assertFalse(build(Double.MIN_VALUE, imaginary).isMathematicalInteger());

        Assertions.assertEquals(expectedForInteger, build(-0.0, imaginary).isMathematicalInteger());
        Assertions.assertEquals(expectedForInteger, build(+0.0, imaginary).isMathematicalInteger());

        for (int i = -1000; i < 1000; ++i) {
            final double d = i;
            Assertions.assertEquals(expectedForInteger, build(d, imaginary).isMathematicalInteger());
            Assertions.assertFalse(build(FastMath.nextAfter(d, Double.POSITIVE_INFINITY), imaginary).isMathematicalInteger());
            Assertions.assertFalse(build(FastMath.nextAfter(d, Double.NEGATIVE_INFINITY), imaginary).isMathematicalInteger());
        }

        double minNoFractional = 0x1l << 52;
        Assertions.assertEquals(expectedForInteger, build(minNoFractional, imaginary).isMathematicalInteger());
        Assertions.assertFalse(build(minNoFractional - 0.5, imaginary).isMathematicalInteger());
        Assertions.assertEquals(expectedForInteger, build(minNoFractional + 0.5, imaginary).isMathematicalInteger());
    ...
    public void testGetArgument() {
        ...
        Assertions.assertEquals(0.0, z.getArgument().getReal(), 1.0e-12);

        z = build(1, 1);
        Assertions.assertEquals(FastMath.PI/4, z.getArgument().getReal(), 1.0e-12);

        z = build(0, 1);
        Assertions.assertEquals(FastMath.PI/2, z.getArgument().getReal(), 1.0e-12);

        z = build(-1, 1);
        Assertions.assertEquals(3 * FastMath.PI/4, z.getArgument().getReal(), 1.0e-12);

        z = build(-1, 0);
        Assertions.assertEquals(FastMath.PI, z.getArgument().getReal(), 1.0e-12);
    ...
    public void testGetArgumentInf() {
        Assertions.assertEquals(FastMath.PI/4, infInf.getArgument().getReal(), 1.0e-12);
        Assertions.assertEquals(FastMath.PI/2, oneInf.getArgument().getReal(), 1.0e-12);
        Assertions.assertEquals(0.0, infOne.getArgument().getReal(), 1.0e-12);
        Assertions.assertEquals(FastMath.PI/2, zeroInf.getArgument().getReal(), 1.0e-12);
        Assertions.assertEquals(0.0, infZero.getArgument().getReal(), 1.0e-12);
        Assertions.assertEquals(FastMath.PI, negInfOne.getArgument().getReal(), 1.0e-12);
        Assertions.assertEquals(-3.0*FastMath.PI/4, negInfNegInf.getArgument().getReal(), 1.0e-12);
        Assertions.assertEquals(-FastMath.PI/2, oneNegInf.getArgument().getReal(), 1.0e-12);
    }
    ...
    public void testGetArgumentNaN() {
        Assertions.assertTrue(Double.isNaN(nanZero.getArgument().getReal()));
        Assertions.assertTrue(Double.isNaN(zeroNaN.getArgument().getReal()));
        Assertions.assertTrue(Double.isNaN(FieldComplex.getNaN(Binary64Field.getInstance()).getArgument().getReal()));
    }

    @Test
    public void testValueOf() {
        Assertions.assertEquals(2.0, FieldComplex.valueOf(new Binary64(2.0)).getRealPart().getReal(), 1.0e-15);
        Assertions.assertEquals(0.0, FieldComplex.valueOf(new Binary64(2.0)).getImaginaryPart().getReal(), 1.0e-15);
        Assertions.assertTrue(FieldComplex.valueOf(new Binary64(Double.NaN)).isNaN());
        Assertions.assertTrue(FieldComplex.valueOf(new Binary64(Double.POSITIVE_INFINITY)).isInfinite());
        Assertions.assertEquals( 2.0, FieldComplex.valueOf(new Binary64(2.0), new Binary64(-1.0)).getRealPart().getReal(), 1.0e-15);
        Assertions.assertEquals(-1.0, FieldComplex.valueOf(new Binary64(2.0), new Binary64(-1.0)).getImaginaryPart().getReal(), 1.0e-15);
        Assertions.assertTrue(FieldComplex.valueOf(new Binary64(Double.NaN), new Binary64(0.0)).isNaN());
        Assertions.assertTrue(FieldComplex.valueOf(new Binary64(Double.POSITIVE_INFINITY), new Binary64(0.0)).isInfinite());
        Assertions.assertTrue(FieldComplex.valueOf(new Binary64(Double.NaN), new Binary64(-1.0)).isNaN());
        Assertions.assertTrue(FieldComplex.valueOf(new Binary64(Double.POSITIVE_INFINITY), new Binary64(-1.0)).isInfinite());
        Assertions.assertTrue(FieldComplex.valueOf(new Binary64(0.0), new Binary64(Double.NaN)).isNaN());
        Assertions.assertTrue(FieldComplex.valueOf(new Binary64(0.0), new Binary64(Double.POSITIVE_INFINITY)).isInfinite());
        Assertions.assertTrue(FieldComplex.valueOf(new Binary64(-1.0), new Binary64(Double.NaN)).isNaN());
        Assertions.assertTrue(FieldComplex.valueOf(new Binary64(-1.0), new Binary64(Double.POSITIVE_INFINITY)).isInfinite());
    }

    @Test
    public void testField() {
        Assertions.assertEquals(FieldComplexField.getField(Binary64Field.getInstance()),
                            FieldComplex.getZero(Binary64Field.getInstance()).getField());
    }

    @Test
    public void testToString() {
        Assertions.assertEquals("(1.0, -2.0)", build(1, -2).toString());
    }

    @Test
    public void testScalbComplex() {
        Assertions.assertEquals(0.125,  build(2.0, 1.0).scalb(-4).getRealPart().getReal(), 1.0e-15);
        Assertions.assertEquals(0.0625, build(2.0, 1.0).scalb(-4).getImaginaryPart().getReal(), 1.0e-15);
    }

    @Test
    public void testHypotComplex() {
        Assertions.assertEquals(5.8269600298808519855, build(3, 4).hypot(build(5, 6)).getRealPart().getReal(), 1.0e-15);
        Assertions.assertEquals(7.2078750814528590485, build(3, 4).hypot(build(5, 6)).getImaginaryPart().getReal(), 1.0e-15);
    }
    ...
    public void testCeilComplex() {
        for (double x = -3.9; x < 3.9; x += 0.05) {
            for (double y = -3.9; y < 3.9; y += 0.05) {
                final FieldComplex<Binary64> z = build(x, y);
                Assertions.assertEquals(FastMath.ceil(x), z.ceil().getRealPart().getReal(), 1.0e-15);
                Assertions.assertEquals(FastMath.ceil(y), z.ceil().getImaginaryPart().getReal(), 1.0e-15);
            }
        }
    }
    ...
    public void testFloorComplex() {
        for (double x = -3.9; x < 3.9; x += 0.05) {
            for (double y = -3.9; y < 3.9; y += 0.05) {
                final FieldComplex<Binary64> z = build(x, y);
                Assertions.assertEquals(FastMath.floor(x), z.floor().getRealPart().getReal(), 1.0e-15);
                Assertions.assertEquals(FastMath.floor(y), z.floor().getImaginaryPart().getReal(), 1.0e-15);
            }
        }
    }
    ...
    public void testRintComplex() {
        for (double x = -3.9; x < 3.9; x += 0.05) {
            for (double y = -3.9; y < 3.9; y += 0.05) {
                final FieldComplex<Binary64> z = build(x, y);
                Assertions.assertEquals(FastMath.rint(x), z.rint().getRealPart().getReal(), 1.0e-15);
                Assertions.assertEquals(FastMath.rint(y), z.rint().getImaginaryPart().getReal(), 1.0e-15);
            }
        }
    }
            ...
            for (double y1 = -3.9; y1 < 3.9; y1 += 0.125) {
                ...
                for (double x2 = -3.92; x2 < 3.9; x2 += 0.125) {
                    for (double y2 = -3.92; y2 < 3.9; y2 += 0.125) {
                        ...
                        Assertions.assertTrue(r.norm() <= z2.norm());
                        Assertions.assertEquals(FastMath.rint(q.getRealPart().getReal()), q.getRealPart().getReal(), 2.0e-14);
                        Assertions.assertEquals(FastMath.rint(q.getImaginaryPart().getReal()), q.getImaginaryPart().getReal(), 2.0e-14);
                    }
                }
            }
        }
        ...
        for (double x1 = -3.9; x1 < 3.9; x1 += 0.125) {
            for (double y1 = -3.9; y1 < 3.9; y1 += 0.125) {
                ...
                for (double a = -3.92; a < 3.9; a += 0.125) {
                        ...
                        Assertions.assertTrue(r.norm() <= FastMath.abs(a));
                        Assertions.assertEquals(FastMath.rint(q.getRealPart().getReal()), q.getRealPart().getReal(), 2.0e-14);
                        Assertions.assertEquals(FastMath.rint(q.getImaginaryPart().getReal()), q.getImaginaryPart().getReal(), 2.0e-14);
                }
            }
    ...
    private void checkRemainder(final FieldComplex<Binary64> c1, final FieldComplex<Binary64> c2, final FieldComplex<Binary64> expectedRemainder) {
        ...
        Assertions.assertEquals(expectedRemainder.getRealPart().getReal(),      remainder.getRealPart().getReal(),      1.0e-15);
        Assertions.assertEquals(expectedRemainder.getImaginaryPart().getReal(), remainder.getImaginaryPart().getReal(), 1.0e-15);

        final FieldComplex<Binary64> crossCheck = c1.subtract(remainder).divide(c2);
        Assertions.assertTrue(Precision.isMathematicalInteger(crossCheck.getRealPart().getReal()));
        Assertions.assertTrue(Precision.isMathematicalInteger(crossCheck.getImaginaryPart().getReal()));
            ...
            for (double y1 = -3.9; y1 < 3.9; y1 += 0.08) {
                ...
                for (double x2 = -3.9; x2 < 3.9; x2 += 0.08) {
                    for (double y2 = -3.9; y2 < 3.9; y2 += 0.08) {
                        final FieldComplex<Binary64> z2 = build(x2, y2);
                        Assertions.assertEquals(FastMath.copySign(x1, x2), z1.copySign(z2).getRealPart().getReal(), 1.0e-15);
                        Assertions.assertEquals(FastMath.copySign(y1, y2), z1.copySign(z2).getImaginaryPart().getReal(), 1.0e-15);
                    }
                }
            }
        }
        ...
        for (double x1 = -3.9; x1 < 3.9; x1 += 0.05) {
            for (double y1 = -3.9; y1 < 3.9; y1 += 0.05) {
                ...
                for (double r = -3.9; r < 3.9; r += 0.05) {
                    Assertions.assertEquals(FastMath.copySign(x1, r), z1.copySign(r).getRealPart().getReal(), 1.0e-15);
                    Assertions.assertEquals(FastMath.copySign(y1, r), z1.copySign(r).getImaginaryPart().getReal(), 1.0e-15);
                }
            }
        }
    }
    ...
    public void testSignumComplex() {
        for (double x = -3.9; x < 3.9; x += 0.05) {
            for (double y = -3.9; y < 3.9; y += 0.05) {
                final FieldComplex<Binary64> z = build(x, y);
                Assertions.assertEquals(1.0, z.sign().norm(), 1.0e-15);
                Assertions.assertEquals(FastMath.copySign(1, FastMath.signum(x)), FastMath.copySign(Binary64.ONE, z.sign().getRealPart()).getReal(), 1.0e-15);
                Assertions.assertEquals(FastMath.copySign(1, FastMath.signum(y)), FastMath.copySign(Binary64.ONE, z.sign().getImaginaryPart()).getReal(), 1.0e-15);
            }
        }
        Assertions.assertTrue(Complex.NaN.sign().isNaN());
        for (int sR : Arrays.asList(-1, +1)) {
            for (int sI : Arrays.asList(-1, +1)) {
                ...
                Assertions.assertTrue(zSign.isZero());
                Assertions.assertEquals(sR, FastMath.copySign(Binary64.ONE, zSign.getRealPart()).getReal(), 1.0e-15);
                Assertions.assertEquals(sI, FastMath.copySign(Binary64.ONE, zSign.getImaginaryPart()).getReal(), 1.0e-15);
            }
        }
    }
    ...
    public void testLinearCombination1() {
        ...
        Assertions.assertTrue(naive.subtract(abSumInline).norm() > 1.5);
    ...
    public void testSignedZeroEquality() {
        ...
        Assertions.assertFalse(build(-0.0, 1.0).isZero());
        Assertions.assertFalse(build(+0.0, 1.0).isZero());
        Assertions.assertFalse(build( 1.0, -0.0).isZero());
        Assertions.assertFalse(build( 1.0, +0.0).isZero());

        Assertions.assertTrue(build(-0.0, -0.0).isZero());
        Assertions.assertTrue(build(-0.0, +0.0).isZero());
        Assertions.assertTrue(build(+0.0, -0.0).isZero());
        Assertions.assertTrue(build(+0.0, +0.0).isZero());

        Assertions.assertNotEquals(build(-0.0, -0.0), FieldComplex.getZero(Binary64Field.getInstance()));
        Assertions.assertNotEquals(build(-0.0, +0.0), FieldComplex.getZero(Binary64Field.getInstance()));
        Assertions.assertNotEquals(build(+0.0, -0.0), FieldComplex.getZero(Binary64Field.getInstance()));
        Assertions.assertEquals(build(+0.0, +0.0), FieldComplex.getZero(Binary64Field.getInstance()));
