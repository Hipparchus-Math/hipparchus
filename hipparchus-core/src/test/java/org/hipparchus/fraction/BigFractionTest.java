...
public class BigFractionTest {
    ...
    public void testConstructor() {
        ...
        Assertions.assertEquals(0.00000000000001, new BigFraction(0.00000000000001).doubleValue(), 0.0);
        Assertions.assertEquals(0.40000000000001, new BigFraction(0.40000000000001).doubleValue(), 0.0);
        Assertions.assertEquals(15.0000000000001, new BigFraction(15.0000000000001).doubleValue(), 0.0);
    ...
    public void testIsInteger() {
        Assertions.assertTrue(new BigFraction(12, 12).isInteger());
        Assertions.assertTrue(new BigFraction(14, 7).isInteger());
        Assertions.assertFalse(new BigFraction(12, 11).isInteger());
    }
    ...
    public void testConstructorDouble() {
        ...
        Assertions.assertEquals(1l, new BigFraction(Double.MAX_VALUE).getDenominatorAsLong());
        Assertions.assertEquals(1l, new BigFraction(Double.longBitsToDouble(0x0010000000000000L)).getNumeratorAsLong());
        Assertions.assertEquals(1l, new BigFraction(Double.MIN_VALUE).getNumeratorAsLong());
    }
    ...
    public void testSignum() {
        Assertions.assertEquals(-1, new BigFraction(4, -5).signum());
        Assertions.assertEquals(-1, new BigFraction(-4, 5).signum());
        Assertions.assertEquals( 0, new BigFraction(0).signum());
        Assertions.assertEquals(+1, new BigFraction(-4, -5).signum());
        Assertions.assertEquals(+1, new BigFraction(4, 5).signum());
    }
    ...
    public void testBigDecimalValue() {
        Assertions.assertEquals(new BigDecimal(0.5), new BigFraction(1, 2).bigDecimalValue());
        Assertions.assertEquals(new BigDecimal("0.0003"), new BigFraction(3, 10000).bigDecimalValue());
        Assertions.assertEquals(new BigDecimal("0"), new BigFraction(1, 3).bigDecimalValue(RoundingMode.DOWN));
        Assertions.assertEquals(new BigDecimal("0.333"), new BigFraction(1, 3).bigDecimalValue(3, RoundingMode.DOWN));
    }
    ...
    public void testGCD() {
      ...
      BigFraction gcd1 = first.gcd(second);
        Assertions.assertEquals(gcd1, BigFraction.getReducedFraction(1, 15));
      BigFraction gcd2 = gcd1.gcd(third);
        Assertions.assertEquals(gcd2, BigFraction.getReducedFraction(1, 105));
      ...
      BigFraction gcd = x.gcd(y);
        Assertions.assertEquals(gcd, BigFraction.getReducedFraction(3, 77));

      x = new BigFraction(13, 6);
      y = new BigFraction(3, 4);
      gcd = x.gcd(y);
        Assertions.assertEquals(gcd, BigFraction.getReducedFraction(1, 12));
    ...
    public void testLCM() {
      ...
      BigFraction lcm1 = first.lcm(second);
        Assertions.assertEquals(lcm1, BigFraction.getReducedFraction(2, 1));
      BigFraction lcm2 = lcm1.lcm(third);
        Assertions.assertEquals(lcm2, BigFraction.getReducedFraction(6, 1));
    }
    ...
    public void testPercentage() {
        Assertions.assertEquals(50.0, new BigFraction(1, 2).percentageValue(), 1.0e-15);
    }

    @Test
    public void testPow() {
        Assertions.assertEquals(new BigFraction(8192, 1594323), new BigFraction(2, 3).pow(13));
        Assertions.assertEquals(new BigFraction(8192, 1594323), new BigFraction(2, 3).pow(13l));
        Assertions.assertEquals(new BigFraction(8192, 1594323), new BigFraction(2, 3).pow(BigInteger.valueOf(13l)));
        Assertions.assertEquals(BigFraction.ONE, new BigFraction(2, 3).pow(0));
        Assertions.assertEquals(BigFraction.ONE, new BigFraction(2, 3).pow(0l));
        Assertions.assertEquals(BigFraction.ONE, new BigFraction(2, 3).pow(BigInteger.valueOf(0l)));
        Assertions.assertEquals(new BigFraction(1594323, 8192), new BigFraction(2, 3).pow(-13));
        Assertions.assertEquals(new BigFraction(1594323, 8192), new BigFraction(2, 3).pow(-13l));
        Assertions.assertEquals(new BigFraction(1594323, 8192), new BigFraction(2, 3).pow(BigInteger.valueOf(-13l)));
    }
    ...
    public void testNormalizedEquals() {
        Assertions.assertEquals(new BigFraction(237, -3871), new BigFraction(-51l, 833l));
    }
    ...
    public void testSerial() {
        ...
        for (BigFraction fraction : fractions) {
            Assertions.assertEquals(fraction, UnitTestUtils.serializeAndRecover(fraction));
        }
    }
    ...
    public void testConvergents() {
        ...
        Assertions.assertEquals(new BigFraction(       3,        1), convergents.get( 0));
        Assertions.assertEquals(new BigFraction(      22,        7), convergents.get( 1));
        Assertions.assertEquals(new BigFraction(     333,      106), convergents.get( 2));
        Assertions.assertEquals(new BigFraction(     355,      113), convergents.get( 3));
        Assertions.assertEquals(new BigFraction(  103993,    33102), convergents.get( 4));
        Assertions.assertEquals(new BigFraction(  104348,    33215), convergents.get( 5));
        Assertions.assertEquals(new BigFraction(  208341,    66317), convergents.get( 6));
        Assertions.assertEquals(new BigFraction(  312689,    99532), convergents.get( 7));
        Assertions.assertEquals(new BigFraction(  833719,   265381), convergents.get( 8));
        Assertions.assertEquals(new BigFraction( 1146408,   364913), convergents.get( 9));
        Assertions.assertEquals(new BigFraction( 4272943,  1360120), convergents.get(10));
        Assertions.assertEquals(new BigFraction( 5419351,  1725033), convergents.get(11));
        Assertions.assertEquals(new BigFraction(80143857, 25510582), convergents.get(12));
        Assertions.assertEquals(13, convergents.size());
    }

    @Test
    public void testLimitedConvergents() {
        double value = FastMath.PI;
        Assertions.assertEquals(new BigFraction(  208341,    66317),
    ...
    public void testTruncatedConvergents() {
        ...
        Assertions.assertEquals(new BigFraction(   355,   113),
                BigFraction.convergent(value, 20, (p, q) -> FastMath.abs(p / (double) q - value) < 1.0e-6).getKey());
        Assertions.assertEquals(new BigFraction(312689, 99532),
    ...
    public void testOutOfRange() {
        ...
        Assertions.assertEquals(36.027247984128935385, f.doubleValue(), 1.0e-15);
    }
