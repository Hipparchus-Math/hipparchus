...
//        Assert.assertFalse(Precision.equals(-128.0f, -128.00000000000006f, 1));
    ...
    public void testRoundFloat() {
        ...
        Assert.assertEquals(1.24f, Precision.round(x, 2, RoundingMode.CEILING), 0.0);
        Assert.assertEquals(1.235f, Precision.round(x, 3, RoundingMode.CEILING), 0.0);
        Assert.assertEquals(1.2346f, Precision.round(x, 4, RoundingMode.CEILING), 0.0);
        Assert.assertEquals(-1.23f, Precision.round(-x, 2, RoundingMode.CEILING), 0.0);
        Assert.assertEquals(-1.234f, Precision.round(-x, 3, RoundingMode.CEILING), 0.0);
        Assert.assertEquals(-1.2345f, Precision.round(-x, 4, RoundingMode.CEILING), 0.0);

        Assert.assertEquals(1.23f, Precision.round(x, 2, RoundingMode.DOWN), 0.0);
        Assert.assertEquals(1.234f, Precision.round(x, 3, RoundingMode.DOWN), 0.0);
        Assert.assertEquals(1.2345f, Precision.round(x, 4, RoundingMode.DOWN), 0.0);
        Assert.assertEquals(-1.23f, Precision.round(-x, 2, RoundingMode.DOWN), 0.0);
        Assert.assertEquals(-1.234f, Precision.round(-x, 3, RoundingMode.DOWN), 0.0);
        Assert.assertEquals(-1.2345f, Precision.round(-x, 4, RoundingMode.DOWN), 0.0);

        Assert.assertEquals(1.23f, Precision.round(x, 2, RoundingMode.FLOOR), 0.0);
        Assert.assertEquals(1.234f, Precision.round(x, 3, RoundingMode.FLOOR), 0.0);
        Assert.assertEquals(1.2345f, Precision.round(x, 4, RoundingMode.FLOOR), 0.0);
        Assert.assertEquals(-1.24f, Precision.round(-x, 2, RoundingMode.FLOOR), 0.0);
        Assert.assertEquals(-1.235f, Precision.round(-x, 3, RoundingMode.FLOOR), 0.0);
        Assert.assertEquals(-1.2346f, Precision.round(-x, 4, RoundingMode.FLOOR), 0.0);

        Assert.assertEquals(1.23f, Precision.round(x, 2, RoundingMode.HALF_DOWN), 0.0);
        Assert.assertEquals(1.235f, Precision.round(x, 3, RoundingMode.HALF_DOWN), 0.0);
        Assert.assertEquals(1.2346f, Precision.round(x, 4, RoundingMode.HALF_DOWN), 0.0);
        Assert.assertEquals(-1.23f, Precision.round(-x, 2, RoundingMode.HALF_DOWN), 0.0);
        Assert.assertEquals(-1.235f, Precision.round(-x, 3, RoundingMode.HALF_DOWN), 0.0);
        Assert.assertEquals(-1.2346f, Precision.round(-x, 4, RoundingMode.HALF_DOWN), 0.0);
        Assert.assertEquals(1.234f, Precision.round(1.2345f, 3, RoundingMode.HALF_DOWN), 0.0);
        Assert.assertEquals(-1.234f, Precision.round(-1.2345f, 3, RoundingMode.HALF_DOWN), 0.0);

        Assert.assertEquals(1.23f, Precision.round(x, 2, RoundingMode.HALF_EVEN), 0.0);
        Assert.assertEquals(1.235f, Precision.round(x, 3, RoundingMode.HALF_EVEN), 0.0);
        Assert.assertEquals(1.2346f, Precision.round(x, 4, RoundingMode.HALF_EVEN), 0.0);
        Assert.assertEquals(-1.23f, Precision.round(-x, 2, RoundingMode.HALF_EVEN), 0.0);
        Assert.assertEquals(-1.235f, Precision.round(-x, 3, RoundingMode.HALF_EVEN), 0.0);
        Assert.assertEquals(-1.2346f, Precision.round(-x, 4, RoundingMode.HALF_EVEN), 0.0);
        Assert.assertEquals(1.234f, Precision.round(1.2345f, 3, RoundingMode.HALF_EVEN), 0.0);
        Assert.assertEquals(-1.234f, Precision.round(-1.2345f, 3, RoundingMode.HALF_EVEN), 0.0);
        Assert.assertEquals(1.236f, Precision.round(1.2355f, 3, RoundingMode.HALF_EVEN), 0.0);
        Assert.assertEquals(-1.236f, Precision.round(-1.2355f, 3, RoundingMode.HALF_EVEN), 0.0);

        Assert.assertEquals(1.23f, Precision.round(x, 2, RoundingMode.HALF_UP), 0.0);
        Assert.assertEquals(1.235f, Precision.round(x, 3, RoundingMode.HALF_UP), 0.0);
        Assert.assertEquals(1.2346f, Precision.round(x, 4, RoundingMode.HALF_UP), 0.0);
        Assert.assertEquals(-1.23f, Precision.round(-x, 2, RoundingMode.HALF_UP), 0.0);
        Assert.assertEquals(-1.235f, Precision.round(-x, 3, RoundingMode.HALF_UP), 0.0);
        Assert.assertEquals(-1.2346f, Precision.round(-x, 4, RoundingMode.HALF_UP), 0.0);
        Assert.assertEquals(1.235f, Precision.round(1.2345f, 3, RoundingMode.HALF_UP), 0.0);
        Assert.assertEquals(-1.235f, Precision.round(-1.2345f, 3, RoundingMode.HALF_UP), 0.0);

        Assert.assertEquals(-1.23f, Precision.round(-1.23f, 2, RoundingMode.UNNECESSARY), 0.0);
        Assert.assertEquals(1.23f, Precision.round(1.23f, 2, RoundingMode.UNNECESSARY), 0.0);
        ...
        Assert.assertEquals(1.24f, Precision.round(x, 2, RoundingMode.UP), 0.0);
        Assert.assertEquals(1.235f, Precision.round(x, 3, RoundingMode.UP), 0.0);
        Assert.assertEquals(1.2346f, Precision.round(x, 4, RoundingMode.UP), 0.0);
        Assert.assertEquals(-1.24f, Precision.round(-x, 2, RoundingMode.UP), 0.0);
        Assert.assertEquals(-1.235f, Precision.round(-x, 3, RoundingMode.UP), 0.0);
        Assert.assertEquals(-1.2346f, Precision.round(-x, 4, RoundingMode.UP), 0.0);
        ...
        // MATH-1070
        Assert.assertEquals(0.0f, Precision.round(0f, 2, RoundingMode.UP), 0.0f);
        Assert.assertEquals(0.05f, Precision.round(0.05f, 2, RoundingMode.UP), 0.0f);
        Assert.assertEquals(0.06f, Precision.round(0.051f, 2, RoundingMode.UP), 0.0f);
        Assert.assertEquals(0.06f, Precision.round(0.0505f, 2, RoundingMode.UP), 0.0f);
        Assert.assertEquals(0.06f, Precision.round(0.059f, 2, RoundingMode.UP), 0.0f);
    }
