...
//        Assertions.assertFalse(Precision.equals(-128.0f, -128.00000000000006f, 1));
    ...
    public void testEqualsWithAllowedUlps() {
        ...
        Assertions.assertTrue(Precision.equals(1.0, 1 + FastMath.ulp(1d), 1));
        Assertions.assertFalse(Precision.equals(1.0, 1 + 2 * FastMath.ulp(1d), 1));
        ...
        Assertions.assertTrue(Precision.equals(0.0, FastMath.ulp(0d), 1));
        Assertions.assertTrue(Precision.equals(0.0, -FastMath.ulp(0d), 1));
    ...
    public void testEqualsIncludingNaNWithAllowedUlps() {
        ...
        Assertions.assertTrue(Precision.equalsIncludingNaN(1.0, 1 + FastMath.ulp(1d), 1));
        Assertions.assertFalse(Precision.equalsIncludingNaN(1.0, 1 + 2 * FastMath.ulp(1d), 1));
        ...
        Assertions.assertTrue(Precision.equalsIncludingNaN(0.0, FastMath.ulp(0d), 1));
        Assertions.assertTrue(Precision.equalsIncludingNaN(0.0, -FastMath.ulp(0d), 1));
    ...
    public void testRoundFloat() {
        ...
        Assertions.assertEquals(1.23f, Precision.round(x, 2), 0.0);
        Assertions.assertEquals(1.235f, Precision.round(x, 3), 0.0);
        Assertions.assertEquals(1.2346f, Precision.round(x, 4), 0.0);

        // BZ 35904
        Assertions.assertEquals(30.1f, Precision.round(30.095f, 2), 0.0f);
        Assertions.assertEquals(30.1f, Precision.round(30.095f, 1), 0.0f);
        Assertions.assertEquals(50.09f, Precision.round(50.085f, 2), 0.0f);
        Assertions.assertEquals(50.19f, Precision.round(50.185f, 2), 0.0f);
        Assertions.assertEquals(50.01f, Precision.round(50.005f, 2), 0.0f);
        Assertions.assertEquals(30.01f, Precision.round(30.005f, 2), 0.0f);
        Assertions.assertEquals(30.65f, Precision.round(30.645f, 2), 0.0f);

        Assertions.assertEquals(1.24f, Precision.round(x, 2, RoundingMode.CEILING), 0.0);
        Assertions.assertEquals(1.235f, Precision.round(x, 3, RoundingMode.CEILING), 0.0);
        Assertions.assertEquals(1.2346f, Precision.round(x, 4, RoundingMode.CEILING), 0.0);
        Assertions.assertEquals(-1.23f, Precision.round(-x, 2, RoundingMode.CEILING), 0.0);
        Assertions.assertEquals(-1.234f, Precision.round(-x, 3, RoundingMode.CEILING), 0.0);
        Assertions.assertEquals(-1.2345f, Precision.round(-x, 4, RoundingMode.CEILING), 0.0);

        Assertions.assertEquals(1.23f, Precision.round(x, 2, RoundingMode.DOWN), 0.0);
        Assertions.assertEquals(1.234f, Precision.round(x, 3, RoundingMode.DOWN), 0.0);
        Assertions.assertEquals(1.2345f, Precision.round(x, 4, RoundingMode.DOWN), 0.0);
        Assertions.assertEquals(-1.23f, Precision.round(-x, 2, RoundingMode.DOWN), 0.0);
        Assertions.assertEquals(-1.234f, Precision.round(-x, 3, RoundingMode.DOWN), 0.0);
        Assertions.assertEquals(-1.2345f, Precision.round(-x, 4, RoundingMode.DOWN), 0.0);

        Assertions.assertEquals(1.23f, Precision.round(x, 2, RoundingMode.FLOOR), 0.0);
        Assertions.assertEquals(1.234f, Precision.round(x, 3, RoundingMode.FLOOR), 0.0);
        Assertions.assertEquals(1.2345f, Precision.round(x, 4, RoundingMode.FLOOR), 0.0);
        Assertions.assertEquals(-1.24f, Precision.round(-x, 2, RoundingMode.FLOOR), 0.0);
        Assertions.assertEquals(-1.235f, Precision.round(-x, 3, RoundingMode.FLOOR), 0.0);
        Assertions.assertEquals(-1.2346f, Precision.round(-x, 4, RoundingMode.FLOOR), 0.0);

        Assertions.assertEquals(1.23f, Precision.round(x, 2, RoundingMode.HALF_DOWN), 0.0);
        Assertions.assertEquals(1.235f, Precision.round(x, 3, RoundingMode.HALF_DOWN), 0.0);
        Assertions.assertEquals(1.2346f, Precision.round(x, 4, RoundingMode.HALF_DOWN), 0.0);
        Assertions.assertEquals(-1.23f, Precision.round(-x, 2, RoundingMode.HALF_DOWN), 0.0);
        Assertions.assertEquals(-1.235f, Precision.round(-x, 3, RoundingMode.HALF_DOWN), 0.0);
        Assertions.assertEquals(-1.2346f, Precision.round(-x, 4, RoundingMode.HALF_DOWN), 0.0);
        Assertions.assertEquals(1.234f, Precision.round(1.2345f, 3, RoundingMode.HALF_DOWN), 0.0);
        Assertions.assertEquals(-1.234f, Precision.round(-1.2345f, 3, RoundingMode.HALF_DOWN), 0.0);

        Assertions.assertEquals(1.23f, Precision.round(x, 2, RoundingMode.HALF_EVEN), 0.0);
        Assertions.assertEquals(1.235f, Precision.round(x, 3, RoundingMode.HALF_EVEN), 0.0);
        Assertions.assertEquals(1.2346f, Precision.round(x, 4, RoundingMode.HALF_EVEN), 0.0);
        Assertions.assertEquals(-1.23f, Precision.round(-x, 2, RoundingMode.HALF_EVEN), 0.0);
        Assertions.assertEquals(-1.235f, Precision.round(-x, 3, RoundingMode.HALF_EVEN), 0.0);
        Assertions.assertEquals(-1.2346f, Precision.round(-x, 4, RoundingMode.HALF_EVEN), 0.0);
        Assertions.assertEquals(1.234f, Precision.round(1.2345f, 3, RoundingMode.HALF_EVEN), 0.0);
        Assertions.assertEquals(-1.234f, Precision.round(-1.2345f, 3, RoundingMode.HALF_EVEN), 0.0);
        Assertions.assertEquals(1.236f, Precision.round(1.2355f, 3, RoundingMode.HALF_EVEN), 0.0);
        Assertions.assertEquals(-1.236f, Precision.round(-1.2355f, 3, RoundingMode.HALF_EVEN), 0.0);

        Assertions.assertEquals(1.23f, Precision.round(x, 2, RoundingMode.HALF_UP), 0.0);
        Assertions.assertEquals(1.235f, Precision.round(x, 3, RoundingMode.HALF_UP), 0.0);
        Assertions.assertEquals(1.2346f, Precision.round(x, 4, RoundingMode.HALF_UP), 0.0);
        Assertions.assertEquals(-1.23f, Precision.round(-x, 2, RoundingMode.HALF_UP), 0.0);
        Assertions.assertEquals(-1.235f, Precision.round(-x, 3, RoundingMode.HALF_UP), 0.0);
        Assertions.assertEquals(-1.2346f, Precision.round(-x, 4, RoundingMode.HALF_UP), 0.0);
        Assertions.assertEquals(1.235f, Precision.round(1.2345f, 3, RoundingMode.HALF_UP), 0.0);
        Assertions.assertEquals(-1.235f, Precision.round(-1.2345f, 3, RoundingMode.HALF_UP), 0.0);

        Assertions.assertEquals(-1.23f, Precision.round(-1.23f, 2, RoundingMode.UNNECESSARY), 0.0);
        Assertions.assertEquals(1.23f, Precision.round(1.23f, 2, RoundingMode.UNNECESSARY), 0.0);
        ...
        Assertions.assertEquals(1.24f, Precision.round(x, 2, RoundingMode.UP), 0.0);
        Assertions.assertEquals(1.235f, Precision.round(x, 3, RoundingMode.UP), 0.0);
        Assertions.assertEquals(1.2346f, Precision.round(x, 4, RoundingMode.UP), 0.0);
        Assertions.assertEquals(-1.24f, Precision.round(-x, 2, RoundingMode.UP), 0.0);
        Assertions.assertEquals(-1.235f, Precision.round(-x, 3, RoundingMode.UP), 0.0);
        Assertions.assertEquals(-1.2346f, Precision.round(-x, 4, RoundingMode.UP), 0.0);
        ...
        Assertions.assertEquals(0.0f, Precision.round(0.0f, 2), 0.0f);
        Assertions.assertEquals(Float.POSITIVE_INFINITY, Precision.round(Float.POSITIVE_INFINITY, 2), 0.0f);
        Assertions.assertEquals(Float.NEGATIVE_INFINITY, Precision.round(Float.NEGATIVE_INFINITY, 2), 0.0f);
        // comparison of positive and negative zero is not possible -> always equal thus do string comparison
        Assertions.assertEquals("-0.0", Float.toString(Precision.round(-0.0f, 0)));
        Assertions.assertEquals("-0.0", Float.toString(Precision.round(-1e-10f, 0)));

        // MATH-1070
        Assertions.assertEquals(0.0f, Precision.round(0f, 2, RoundingMode.UP), 0.0f);
        Assertions.assertEquals(0.05f, Precision.round(0.05f, 2, RoundingMode.UP), 0.0f);
        Assertions.assertEquals(0.06f, Precision.round(0.051f, 2, RoundingMode.UP), 0.0f);
        Assertions.assertEquals(0.06f, Precision.round(0.0505f, 2, RoundingMode.UP), 0.0f);
        Assertions.assertEquals(0.06f, Precision.round(0.059f, 2, RoundingMode.UP), 0.0f);
    }


    @Test
    public void testIssue721() {
        Assertions.assertEquals(-53,   FastMath.getExponent(Precision.EPSILON));
        Assertions.assertEquals(-1022, FastMath.getExponent(Precision.SAFE_MIN));
    }
    ...
    public void testIsMathematicalIntegerDouble() {
        ...
        Assertions.assertFalse(Precision.isMathematicalInteger(Double.NaN));
        Assertions.assertFalse(Precision.isMathematicalInteger(Double.POSITIVE_INFINITY));
        Assertions.assertFalse(Precision.isMathematicalInteger(Double.NEGATIVE_INFINITY));
        Assertions.assertFalse(Precision.isMathematicalInteger(Double.MIN_NORMAL));
        Assertions.assertFalse(Precision.isMathematicalInteger(Double.MIN_VALUE));

        Assertions.assertTrue(Precision.isMathematicalInteger(-0.0));
        Assertions.assertTrue(Precision.isMathematicalInteger(+0.0));

        for (int i = -1000; i < 1000; ++i) {
            final double d = i;
            Assertions.assertTrue(Precision.isMathematicalInteger(d));
            Assertions.assertFalse(Precision.isMathematicalInteger(FastMath.nextAfter(d, Double.POSITIVE_INFINITY)));
            Assertions.assertFalse(Precision.isMathematicalInteger(FastMath.nextAfter(d, Double.NEGATIVE_INFINITY)));
        }

        double minNoFractional = 0x1l << 52;
        Assertions.assertTrue(Precision.isMathematicalInteger(minNoFractional));
        Assertions.assertFalse(Precision.isMathematicalInteger(minNoFractional - 0.5));
        Assertions.assertTrue(Precision.isMathematicalInteger(minNoFractional + 0.5));
    ...
    public void testIsMathematicalIntegerFloat() {
        ...
        Assertions.assertFalse(Precision.isMathematicalInteger(Float.NaN));
        Assertions.assertFalse(Precision.isMathematicalInteger(Float.POSITIVE_INFINITY));
        Assertions.assertFalse(Precision.isMathematicalInteger(Float.NEGATIVE_INFINITY));
        Assertions.assertFalse(Precision.isMathematicalInteger(Float.MIN_NORMAL));
        Assertions.assertFalse(Precision.isMathematicalInteger(Float.MIN_VALUE));

        Assertions.assertTrue(Precision.isMathematicalInteger(-0.0f));
        Assertions.assertTrue(Precision.isMathematicalInteger(+0.0f));

        for (int i = -1000; i < 1000; ++i) {
            final float f = i;
            Assertions.assertTrue(Precision.isMathematicalInteger(f));
            Assertions.assertFalse(Precision.isMathematicalInteger(FastMath.nextAfter(f, Float.POSITIVE_INFINITY)));
            Assertions.assertFalse(Precision.isMathematicalInteger(FastMath.nextAfter(f, Float.NEGATIVE_INFINITY)));
        }

        float minNoFractional = 0x1l << 23;
        Assertions.assertTrue(Precision.isMathematicalInteger(minNoFractional));
        Assertions.assertFalse(Precision.isMathematicalInteger(minNoFractional - 0.5f));
        Assertions.assertTrue(Precision.isMathematicalInteger(minNoFractional + 0.5f));
