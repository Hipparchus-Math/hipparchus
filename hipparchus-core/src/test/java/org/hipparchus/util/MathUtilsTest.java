...
public final class MathUtilsTest {
    ...
    public void testEqualsDouble() {
        ...
        Assertions.assertTrue(MathUtils.equals(x, x));
        Assertions.assertFalse(MathUtils.equals(x, -x));

        // Special cases (cf. semantics of JDK's "Double").
        // 1. NaN
        Assertions.assertTrue(MathUtils.equals(Double.NaN, Double.NaN));
        // 2. Negative zero
        final double mZero = -0d;
        final double zero = 0d;
        Assertions.assertTrue(MathUtils.equals(zero, zero));
        Assertions.assertTrue(MathUtils.equals(mZero, mZero));
        Assertions.assertFalse(MathUtils.equals(mZero, zero));
    }
    ...
    public void testHash() {
        ...
        for (int i = 0; i < testArray.length; i++) {
            for (int j = 0; j < testArray.length; j++) {
                if (i == j) {
                    Assertions.assertEquals(MathUtils.hash(testArray[i]), MathUtils.hash(testArray[j]));
                    Assertions.assertEquals(MathUtils.hash(testArray[j]), MathUtils.hash(testArray[i]));
                } else {
                    Assertions.assertTrue(MathUtils.hash(testArray[i]) != MathUtils.hash(testArray[j]));
                    Assertions.assertTrue(MathUtils.hash(testArray[j]) != MathUtils.hash(testArray[i]));
                }
            }
        }
    }
    ...
    public void testArrayHash() {
        Assertions.assertEquals(0, MathUtils.hash((double[]) null));
        Assertions.assertEquals(MathUtils.hash(new double[] {
        ...
        Assertions.assertFalse(MathUtils.hash(new double[] { 1d }) ==
    ...
    public void testPermutedArrayHash() {
        ...
        Assertions.assertFalse(MathUtils.hash(original) == MathUtils.hash(permuted));
    }

    @Test
    public void testIndicatorByte() {
        Assertions.assertEquals((byte)1, MathUtils.copySign((byte)1, (byte)2));
        Assertions.assertEquals((byte)1, MathUtils.copySign((byte)1, (byte)0));
        Assertions.assertEquals((byte)(-1), MathUtils.copySign((byte)1, (byte)(-2)));
    }

    @Test
    public void testIndicatorInt() {
        Assertions.assertEquals(1, MathUtils.copySign(1, 2));
        Assertions.assertEquals(1, MathUtils.copySign(1, 0));
        Assertions.assertEquals((-1), MathUtils.copySign(1, -2));
    }

    @Test
    public void testIndicatorLong() {
        Assertions.assertEquals(1L, MathUtils.copySign(1L, 2L));
        Assertions.assertEquals(1L, MathUtils.copySign(1L, 0L));
        Assertions.assertEquals(-1L, MathUtils.copySign(1L, -2L));
    }

    @Test
    public void testIndicatorShort() {
        Assertions.assertEquals((short)1, MathUtils.copySign((short)1, (short)2));
        Assertions.assertEquals((short)1, MathUtils.copySign((short)1, (short)0));
        Assertions.assertEquals((short)(-1), MathUtils.copySign((short)1, (short)(-2)));
    }
    ...
    public void testNormalizeAngle() {
        for (double a = -15.0; a <= 15.0; a += 0.1) {
            for (double b = -15.0; b <= 15.0; b += 0.2) {
                ...
                Assertions.assertTrue((b - FastMath.PI) <= c);
                Assertions.assertTrue(c <= (b + FastMath.PI));
                double twoK = FastMath.rint((a - c) / FastMath.PI);
                Assertions.assertEquals(c, a - twoK * FastMath.PI, 1.0e-14);
            }
        }
    }
    ...
    private <T extends CalculusFieldElement<T>> void doTestFieldNormalizeAngle(final Field<T> field) {
        ...
        for (double a = -15.0; a <= 15.0; a += 0.1) {
            for (double b = -15.0; b <= 15.0; b += 0.2) {
                ...
                double cR = c.getReal();
                Assertions.assertTrue((b - FastMath.PI) <= cR);
                Assertions.assertTrue(cR <= (b + FastMath.PI));
                double twoK = FastMath.rint((a - cR) / FastMath.PI);
                Assertions.assertEquals(cR, a - twoK * FastMath.PI, 1.0e-14);
            }
        }
    }
    ...
    public void testReduce() {
        ...
        Assertions.assertTrue(Double.isNaN(MathUtils.reduce(orig, Double.NaN, offset)));
        Assertions.assertTrue(Double.isNaN(MathUtils.reduce(Double.NaN, period, offset)));
        Assertions.assertTrue(Double.isNaN(MathUtils.reduce(orig, period, Double.NaN)));
        Assertions.assertTrue(Double.isNaN(MathUtils.reduce(orig, period,
                Double.POSITIVE_INFINITY)));
        Assertions.assertTrue(Double.isNaN(MathUtils.reduce(Double.POSITIVE_INFINITY,
                period, offset)));
        Assertions.assertTrue(Double.isNaN(MathUtils.reduce(orig,
    ...
    public void testReduceComparedWithNormalizeAngle() {
        ...
        for (double a = -15; a <= 15; a += 0.5) {
            for (double center = -15; center <= 15; center += 1) {
                ...
                Assertions.assertEquals(nA, r + offset, tol);
            }
        }
    }
    ...
    public void testSignByte() {
        ...
        Assertions.assertEquals((byte) 1, MathUtils.copySign(one, (byte) 2));
        Assertions.assertEquals((byte) (-1), MathUtils.copySign(one, (byte) (-2)));
    }
    ...
    public void testSignInt() {
        final int one = 1;
        Assertions.assertEquals(1, MathUtils.copySign(one, 2));
        Assertions.assertEquals((-1), MathUtils.copySign(one, -2));
    }
    ...
    public void testSignLong() {
        final long one = 1L;
        Assertions.assertEquals(1L, MathUtils.copySign(one, 2L));
        Assertions.assertEquals(-1L, MathUtils.copySign(one, -2L));
    }
    ...
    public void testSignShort() {
        ...
        Assertions.assertEquals((short) 1, MathUtils.copySign(one, (short) 2));
        Assertions.assertEquals((short) (-1), MathUtils.copySign(one, (short) (-2)));
    }
    ...
    public void testTwoSum() {
        ...
        Assertions.assertEquals(a1 + b1, result1.getSum(), 0.);
        Assertions.assertEquals(a1 + b1, result1.getSum() + result1.getResidual(), 0.);
        Assertions.assertNotEquals(0., result1.getResidual(), 0.);
        ...
        Assertions.assertEquals(a2 + b2, result2.getSum(), 0.);
        Assertions.assertEquals(a2 + b2, result2.getSum() + result2.getResidual(), 0.);
        Assertions.assertNotEquals(0., result2.getResidual(), 0.);
        ...
        Assertions.assertEquals(a3 + b3, result3.getSum(), 0.);
        Assertions.assertEquals(a3 + b3, result3.getSum() + result3.getResidual(), 0.);
        Assertions.assertNotEquals(0., result3.getResidual(), 0.);
        ...
        Assertions.assertEquals(a4 + b4, result4.getSum(), 0.);
        Assertions.assertEquals(a4 + b4, result4.getSum() + result4.getResidual(), 0.);
        Assertions.assertNotEquals(0., result4.getResidual(), 0.);
    }
    ...
    public void testTwoSumField() {
        ...
        for (int i = 0; i < a.getDimension(); ++i) {
            Assertions.assertEquals(a.getComponent(i) + b.getComponent(i), result.getSum().getComponent(i), 0.);
            Assertions.assertEquals(a.getComponent(i) + b.getComponent(i),
                    result.getSum().getComponent(i) + result.getResidual().getComponent(i), 0.);
            Assertions.assertNotEquals(0., result.getResidual().getComponent(i), 0.);
        }
    }
