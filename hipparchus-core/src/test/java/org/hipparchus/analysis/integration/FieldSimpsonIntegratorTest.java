...
public final class FieldSimpsonIntegratorTest {
    ...
    public void testSinFunction() {
        FieldUnivariateIntegrator<Decimal64> integrator = new FieldSimpsonIntegrator<>(Decimal64Field.getInstance());
    ...
    public void testParameters() {
        try {
            // bad interval
            new FieldSimpsonIntegrator<>(Decimal64Field.getInstance()).integrate(1000, x -> x.sin(),
