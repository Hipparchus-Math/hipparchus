 ...
 * {@link MultivariateSummaryStatisticsImpl} instance with dimension n and then use
 ...
 */
class MultivariateSummaryStatisticsImpl
    ...
    MultivariateSummaryStatisticsImpl(Builder builder) {
        ...
        covarianceImpl = new VectorialCovariance(k, builder.covarianceBiasCorrected);
    }
