    ...
    stages {
        ...
        stage('Build') {
            steps {
                ...
                jacoco execPattern:'**/jacoco.exec', classPattern: '**/classes', sourcePattern: '**/src/main/java', exclusionPattern: 'hipparchus-migration/*', exclusionPattern: 'hipparchus-samples/*'
            }
        }
