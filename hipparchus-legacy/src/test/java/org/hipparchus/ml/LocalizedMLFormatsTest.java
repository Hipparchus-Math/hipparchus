...
public class LocalizedMLFormatsTest extends LocalizedFormatsAbstractTest {

    @Override
    protected Class<LocalizedMLFormats> getFormatsClass() {
        return LocalizedMLFormats.class;
    }
