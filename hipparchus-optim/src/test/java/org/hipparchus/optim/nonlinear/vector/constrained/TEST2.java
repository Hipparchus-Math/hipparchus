...
public class TEST2 {
    ...
    public static void main(String[] args) {
        ...
        LinearEqualityConstraint eqc = new LinearEqualityConstraint(
                                                                    new double[][] { { 1.0, 2.0 } },  // constraint y = 1,
                                                                    new double[] { 1 });
        ...
        //ADMMQP optimizer2 = new ADMMQP();
        optimizer2.optimize(new ObjectiveFunction(q),eqc,ineqc);

        SQPOptimizerS optimizer3 = new SQPOptimizerS();
        LagrangeSolution sol = optimizer3.optimize(new InitialGuess(new double[]{10.5,10.5}),new ObjectiveFunction(q),eqc,ineqc);
