 ...
 * </p>
 */
public enum LocalizedFilteringFormats implements Localizable {
     ...
     */
    LocalizedFilteringFormats(final String sourceFormat) {
    ...
    public String getLocalizedString(final Locale locale) {
        try {
            final String path = LocalizedFilteringFormats.class.getName().replaceAll("\\.", "/");
