 ...
 * @since 2.2
 */
public enum LocalizedFittingFormats implements Localizable {
     ...
     */
    LocalizedFittingFormats(final String sourceFormat) {
    ...
    public String getLocalizedString(final Locale locale) {
        try {
            final String path = LocalizedFittingFormats.class.getName().replaceAll("\\.", "/");
